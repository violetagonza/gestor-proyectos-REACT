...
const Card = (props) => {
  ...
  return (
    <Link title='Editar tarea' to={`/task/${props.id}`}>
      <article id={props.id} className='js-card app-card m-1 mb-2 p-2 bg-white rounded-sm app-cursor-pointer shadow-sm' title='Abrir la tarjeta'>
